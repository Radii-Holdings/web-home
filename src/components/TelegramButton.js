        ...
        <>
          <div className="relative group">
            <button
              onClick={() =>
                handleShare(
                  `https://www.linkedin.com/shareArticle?mini=true&url=${currentUrl}&title=${title}&summary=${description}`
                )
              }
          ...
          <div className="relative group">
            <button
              onClick={() =>
                handleShare(
                  `https://twitter.com/intent/tweet?url=${currentUrl}&text=${title}%20-%20${description}`
                )
              }
